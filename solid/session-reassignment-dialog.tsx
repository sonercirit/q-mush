          ...
          <div class="w-full max-w-xl rounded-3xl border border-white/15 bg-slate-900 p-5 shadow-2xl shadow-black/60 sm:p-7">
            ...
            >
              <p>
                ...
                running, stopped, and failed sessions.
              </p>
              <p>
            ...
            <div class="mt-7 flex flex-col-reverse gap-3 sm:flex-row sm:justify-end">
              <button
                class="rounded-xl border border-white/10 px-4 py-2.5 text-sm font-semibold text-slate-300 transition hover:border-white/20 hover:text-white disabled:cursor-wait disabled:opacity-50"
                disabled={current.pending}
                onClick={close}
                type="button"
              >
              ...
              <button
                class="rounded-xl bg-emerald-300 px-4 py-2.5 text-sm font-semibold text-slate-950 transition hover:bg-emerald-200 disabled:cursor-wait disabled:opacity-60"
                disabled={current.pending}
