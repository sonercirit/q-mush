    ...
    <>
      ...
      <div>
        ...
        <p class="mt-1 text-xs text-slate-500">
          Up to {String(PROMPT_BODY_MAXIMUM_BYTES / 1_024)} KiB.
        </p>
      </div>
    </>
  );
    ...
    >
      {(prompts) => (
        ...
        >
          ...
          <button
            class="mt-5 rounded-xl border border-emerald-300/30 bg-emerald-300/10 px-5 py-3 font-semibold text-emerald-200 disabled:opacity-50"
