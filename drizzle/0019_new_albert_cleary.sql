...
CREATE TABLE `__new_runners` (
	...
	CONSTRAINT "runners_activation_phase_identity_check" CHECK(("__new_runners"."activation_phase" IS NULL AND "__new_runners"."activation_id" IS NULL AND "__new_runners"."activation_lifecycle" IS NULL) OR ("__new_runners"."activation_phase" IS NOT NULL AND "__new_runners"."activation_phase" IN ('prepared', 'finalized') AND "__new_runners"."activation_id" IS NOT NULL AND "__new_runners"."activation_lifecycle" IS NOT NULL AND "__new_runners"."activation_lifecycle" IN ('ordinary', 'restart'))),
	...
	CONSTRAINT "runners_activation_lifecycle_restart_check" CHECK(("__new_runners"."activation_lifecycle" IS NULL AND "__new_runners"."activation_restart_id" IS NULL) OR ("__new_runners"."activation_lifecycle" IS NOT NULL AND "__new_runners"."activation_lifecycle" = 'ordinary' AND "__new_runners"."activation_restart_id" IS NULL) OR ("__new_runners"."activation_lifecycle" IS NOT NULL AND "__new_runners"."activation_lifecycle" = 'restart' AND "__new_runners"."activation_restart_id" IS NOT NULL)),
