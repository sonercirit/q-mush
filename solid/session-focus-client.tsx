...
export function SessionResults(props: SessionResultsProps): JSX.Element {
  ...
  return (
    <div
      class="session-results mt-7 grid min-h-0 min-w-0 auto-rows-fr items-stretch gap-4 lg:grid-cols-[18rem_minmax(0,1fr)] xl:grid-cols-[20rem_minmax(0,1fr)]"
    ...
    >
      ...
      <aside
        ...
        class="session-list-panel relative min-h-0 min-w-0 self-stretch overflow-hidden"
        data-session-list-open={String(listOpen())}
        ...
        ref={setListPanel}
      >
        <div class="session-list-surface absolute inset-0 flex h-full min-h-0 flex-col overflow-hidden">
