...
CREATE TABLE `__new_agent_sessions` (
	...
	`title` text NOT NULL,
	`tools` text DEFAULT '["read","bash","edit","write","parallel","brave_search","ask_questions","spawn_session","list_sessions","read_session","send_to_session","continue_session","stop_session"]' NOT NULL,
...
--> statement-breakpoint
INSERT INTO `__new_agent_sessions`("id", "user_id", "created_at", "created_by_id", "updated_at", "updated_by_id", "is_deleted", "parent_session_id", "runner_id", "provider_credential_id", "provider", "provider_pricing", "model", "auto_compact", "active_duration_ms", "active_started_at", "cost_basis", "cost_usd", "current_context_tokens", "max_context_tokens", "agent_file_name", "agent_file_content", "reasoning_effort", "working_directory", "title", "tools", "status") SELECT "id", "user_id", "created_at", "created_by_id", "updated_at", "updated_by_id", "is_deleted", "parent_session_id", "runner_id", "provider_credential_id", "provider", "provider_pricing", "model", "auto_compact", "active_duration_ms", "active_started_at", "cost_basis", "cost_usd", "current_context_tokens", "max_context_tokens", "agent_file_name", "agent_file_content", "reasoning_effort", "working_directory", "title", "tools", "status" FROM `agent_sessions`;--> statement-breakpoint
